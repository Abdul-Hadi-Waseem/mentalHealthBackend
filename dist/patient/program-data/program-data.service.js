...
exports.ProgramDataService = void 0;
const common_1 = require("@nestjs/common");
const utility_class_1 = require("../../shared-module/generic/utility.class");
const typeorm_1 = require("typeorm");
const form_constant_1 = require("./form.constant");
let ProgramDataService = class ProgramDataService {
    constructor(connection, utility) {
        this.connection = connection;
        this.utility = utility;
        this.pscAnswers = [{ Never: 0, Sometimes: 1, Often: 2 }];
        this.score_ranges = [
        ...
        this.quiz = [
            {
                question: 'Most of the time do you find yourself taking actions for the plans you have set for your daily life?',
                options: [
                    {
                        text: 'Yes',
                        score: 0,
            ...
            {
                question: 'Do you often find yourself having negative thoughts, repetitively?',
                options: [
                    {
                        text: 'Yes',
                        score: 15,
            ...
            {
                question: 'Most of the time, do you find yourself being present at the moment?',
                options: [
                    {
                        text: 'Most of the time',
                        score: 5,
    ...
    async programData(argsData) {
        try {
            let emailSubject;
            let emailMessage;
            if (form_constant_1.ProgramFormEnum.Anxiety.ID === argsData.formId) {
                const anxietyQuiz = await this.anxietyQuizCalculateResult(this.quiz, JSON.parse(JSON.stringify(argsData.metadata)));
                ...
                console.log(...oo_oo(`663467210_165_8_165_48_4`, 'Total Score:', anxietyQuiz));
            }
            if (form_constant_1.ProgramFormEnum.Child_Intake.ID === argsData.formId) {
                argsData.name = form_constant_1.ProgramFormEnum.Child_Intake.NAME;
                argsData.score = '0';
                emailSubject = form_constant_1.ProgramFormEnum.Child_Intake.NAME;
                emailMessage = `Thank you for given test`;
                await this.insertForm(argsData);
            }
            if (form_constant_1.ProgramFormEnum.PSC_Child.ID === argsData.formId) {
                const pscScore = await this.pscQuizResult(form_constant_1.ProgramFormEnum.PSC_Child.NAME, argsData.metadata);
            ...
            if (form_constant_1.ProgramFormEnum.PSC_Youth.ID === argsData.formId) {
                const pscScore = await this.pscQuizResult(form_constant_1.ProgramFormEnum.PSC_Youth.NAME, argsData.metadata);
                argsData.name = pscScore['testName'];
                argsData.score = pscScore['score'];
                emailSubject = pscScore['testName'];
                emailMessage = `Your Test Result is ${pscScore['result']}`;
            ...
            const DynamicResult = await this.utility.dynamicQuery(_dataEmail, argsData.uid.toString().trim());
            console.log(...oo_oo(`663467210_206_6_206_52_4`, DynamicResult['data'][0]['email']));
            this.utility.sendEmail(DynamicResult['data'][0]['email'], emailSubject, JSON.stringify(emailMessage));
            return emailMessage;
        }
        catch (ex) {
            return ex;
    ...
    async insertForm(argsData) {
        try {
            const insertResponse = await this.connection.query(`INSERT INTO public.p02_program_data
         ...
         VALUES($1,$2,$3,$4,$5,$6,$7)`, [
            ...
            console.log(...oo_oo(`663467210_239_6_239_33_4`, insertResponse));
        }
        catch (ex) {
            console.log(...oo_oo(`663467210_241_6_241_21_4`, ex));
        }
    }
    async pscQuizResult(TestName, metadata) {
        try {
            let score = 0;
            const meta = JSON.parse(JSON.stringify(metadata));
            meta === null || meta === void 0 ? void 0 : meta.map((val) => {
                console.log(...oo_oo(`663467210_250_8_250_79_4`, 'never', val['answer'].toLowerCase().toString() == 'never'));
                if (val['answer'].toLowerCase().toString() == 'never') {
                    score += this.pscAnswers[0].Never;
                }
                console.log(...oo_oo(`663467210_254_8_254_79_4`, 'often', val['answer'].toLowerCase().toString() == 'often'));
                if (val['answer'].toLowerCase().toString() == 'often') {
                    score += this.pscAnswers[0].Often;
                }
                console.log(...oo_oo(`663467210_258_8_261_9_4`, 'sometimes', val['answer'].toLowerCase().toString() == 'sometimes'));
                if (val['answer'].toLowerCase().toString() == 'sometimes') {
                    score += this.pscAnswers[0].Sometimes;
                }
                console.log(...oo_oo(`663467210_265_8_265_26_4`, score));
                return val;
            });
            const result = score >= 40 && score <= 50
                ? '(You are Stressed)'
                : score >= 51 && score <= 70
            ...
            console.log(...oo_oo(`663467210_276_6_276_33_4`, 'total', score));
            console.log(...oo_oo(`663467210_277_6_277_35_4`, 'result', result));
            return { score: score, testName: TestName, result: result };
        }
        catch (ex) {
            console.log(...oo_oo(`663467210_280_6_280_21_4`, ex));
        }
    }
    async anxietyQuizCalculateResult(quiz, submittedAnswers) {
        let totalScore = 0;
        console.log(...oo_oo(`663467210_286_4_286_33_4`, submittedAnswers));
        submittedAnswers.forEach((submittedAnswer) => {
            const matchingQuestion = quiz.find((q) => q.question === submittedAnswer.question, console.log(...oo_oo(`663467210_291_8_291_67_4`, (q) => q.question === submittedAnswer.question)));
            console.log(...oo_oo(`663467210_293_6_293_35_4`, matchingQuestion));
            if (matchingQuestion) {
                const matchingOption = matchingQuestion.options.find((option) => option.text === submittedAnswer.answer);
                console.log(...oo_oo(`663467210_299_8_299_35_4`, matchingOption));
                if (matchingOption) {
                    totalScore += matchingOption.score;
                    console.log(...oo_oo(`663467210_303_10_303_33_4`, totalScore));
                }
            }
        });
        ...
        console.log(...oo_oo(`663467210_311_4_311_30_4`, anxietyResult));
        return {
            testName: 'Anxiety',
            score: anxietyResult,
        };
...
exports.ProgramDataService = ProgramDataService;
;
function oo_cm() { try {
